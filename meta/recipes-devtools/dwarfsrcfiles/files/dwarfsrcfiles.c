...
main (int argc, char **argv)
{
  ...
  // Pretend "dwarfsrcfiles -e <file>" was given, so we can use the standard
  // dwfl argp parser to open the file for us and get our Dwfl.
  args[0] = argv[0];
  args[1] = "-e";
  args[2] = argv[1];
  // Do not follow debug-linked files; another packaging worker may be
  // changing the linked binary at the same time.
